...
pdf(paste0("plots/",fname,"PannelD_BPtype_proportion.pdf"),width = 10,height = 10)
...
pdf(paste0("plots/",fname,"_PannelF_Heatmap.pdf"))
...
pdf(paste0("plots/",fname,"_PannelF_volcano.pdf"))
